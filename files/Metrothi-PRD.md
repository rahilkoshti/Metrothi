...
**Critical path:** Phases 1–4 are shipped, so everything that changes what a rider sees mid-journey is done, and the data is now reachable by mode as well as by name. 5–6 are refinements, and phase 5 is the only item that could be cut outright.
