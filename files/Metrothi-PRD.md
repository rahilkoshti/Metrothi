...
**Critical path:** Phases 1–3 are shipped, so everything that changes what a rider sees mid-journey is done. 4–6 are refinements, and phase 5 is the only item that could be cut outright.
